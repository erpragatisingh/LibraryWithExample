...
package com.pragati.cropper.cropwindow;
...
import com.pragati.cropper.cropwindow.edge.Edge;
import com.pragati.cropper.cropwindow.handle.Handle;
import com.pragati.cropper.util.AspectRatioUtil;
import com.pragati.cropper.util.HandleUtil;
import com.pragati.cropper.util.PaintUtil;
...
//            final float verticalPadding = 0.1f * bitmapRect.height();
        	Log.d("URIPISACA", "bitmapRect.height():" + bitmapRect.height());
        	Log.d("URIPISACA", "bitmapRect.width():" + bitmapRect.width());
        	
        	Log.d("URIPISACA", "getHeight:" + getHeight(getContext()));
        	Log.d("URIPISACA", "getWidth:" + getWidth(getContext()));
        	
        	int minCrop= Math.min(bitmapRect.height(), bitmapRect.width());
        	Log.d("URIPISACA", "minCrop:" +minCrop);
			final float horizontalPadding = (getWidth(getContext())- minCrop)/2;
            final float verticalPadding =  (getHeight(getContext())- minCrop)/2;
//            final float verticalPadding = ((float)(bitmapRect.height()-bitmapRect.width()))/2;

            Edge.LEFT.setCoordinate(0 + horizontalPadding);
            Edge.TOP.setCoordinate(0 + verticalPadding);
            Edge.RIGHT.setCoordinate(horizontalPadding + minCrop);
            Edge.BOTTOM.setCoordinate(verticalPadding + minCrop);
        }
    }
